...
def _enrich(individual: Individual, asset_count: int) -> dict:
    ...
    return {
        ...
        "voter_id_number": individual.voter_id_number,
        "skywards_number": individual.skywards_number,
        "maharaja_number": individual.maharaja_number,
        "indigo_chip_number": individual.indigo_chip_number,
        "visas": visas,
